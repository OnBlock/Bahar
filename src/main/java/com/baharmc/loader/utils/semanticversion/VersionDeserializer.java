...
public class VersionDeserializer implements JsonDeserializer<Version> {
	public static SemanticVersion deserializeSemantic(@NotNull String s) throws VersionParsingException {
		if (s.isEmpty()) {
	...
	public static Version deserialize(@NotNull String s) throws VersionParsingException {
		if (s.isEmpty()) {
			throw new VersionParsingException("Version must be a non-empty string!");
		}
	...
	@Override
	public Version deserialize(@NotNull JsonElement json, @NotNull Type typeOfT,
